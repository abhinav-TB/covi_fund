...
import background from '../img/fourm_back.jpg'
import './Forum.css'
import '../App.css';
...
class Forum extends Component {
  ...
  render() {
    ...
    return (
      <div className="wrapper back-img">
        <Navbar />
            ...
            <main role="main" className="col-lg-12 ml-auto mr-auto" style={{ maxWidth: '500px' }}>
              <div className="content mr-auto ml-auto">
                ...
                <div className="eleven">
                  <h1>Fund For A Noble Cause</h1>
                </div>
{/* 
                <h1>Search <br /><br />NGO <br /><br />Individual Posts </h1> */}
                <br></br>
                  <div className="search-box">
                    <input type="text" className="search-input " placeholder="Search.."  value={this.state.search} onChange={this.updateSearch.bind(this)} />
